    ...
    <Container fluid className="mt-4 bg-black text-white">
      <div className="d-flex justify-content-around flex-wrap">
        <section className="footerContainer mt-5">
          <h3 className="mb-4 ms-5">Estudio Cardozo & Asociados</h3>
        </section>
        ...
        <section>
          <div className="SocialFooter mt-4">
            <a
              href="https://www.instagram.com/abogadasasociadastucuman/"
              target="_blank"
              rel="noopener noreferrer"
              className="social"
            >
      ...
      <section className="text-center">
        <h6>© 2025 Estudio Cardozo & Asociados - Todos los derechos reservados.</h6>
      </section>
    </Container>
  );
};
